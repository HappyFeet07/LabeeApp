      ...
      {props.AnnList.map((Ann) => {
        return(
          <Box key={Ann.id} direction="row" 
            ...
            onClick={() => props.UpdateTag(Ann.name, Ann.color)} background='white' width='7vw' align='center' justify='between'
            >
            <Text>{Ann.name}</Text>
